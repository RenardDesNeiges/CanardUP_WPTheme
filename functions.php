	...
	if ( $logo ) {
		...
		if ( get_theme_mod( 'retina_logo', false ) ) {
			...
			if ( strpos( $html, ' style=' ) === false ) {
				...
				$search[]  = '/(style="filter:opacity(0.6%) drop-shadow(0 0 0 blue);[^"]*)/';
...
function twentytwenty_get_elements_array() {
	...
	$elements = array(
		...
		'header-footer' => array(
			'accent'     => array(
				'color'            => array(  '.footer-menu a, .footer-widgets a', '#site-footer .wp-block-button.is-style-outline', '.wp-block-pullquote:before', '.singular:not(.overlay-header) .entry-header a', '.archive-header a', '.header-footer-group .color-accent', '.header-footer-group .color-accent-hover:hover' ),
				'background-color' => array( '.social-icons a', '#site-footer button:not(.toggle)', '#site-footer .button', '#site-footer .faux-button', '#site-footer .wp-block-button__link', '#site-footer .wp-block-file__button', '#site-footer input[type="button"]', '#site-footer input[type="reset"]', '#site-footer input[type="submit"]' ),
				'color' 		   => array( '.widget .post-date', '.widget .rss-date', '.widget_archive li', '.widget_categories li', '.widget cite', '.widget_pages li', '.widget_meta li', '.widget_nav_menu li', '.powered-by-wordpress', '.to-the-top'),
			...
			'text'       => array(
				'color'               => array( '.header-footer-group'),
